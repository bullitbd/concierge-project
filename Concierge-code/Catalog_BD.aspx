<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalog_BD.aspx.vb" Inherits="Catalog_BD"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //this function gets called after field validation when build button clicked
        function embedType () {
        var rIframe = /<iframe>.*?((src=|height|width).*?){3}<\/iframe>/i;
        var rScript = /^<script>.*?<\/script>$/mi;  //placeholder
        var rObject = /^<object>.*?<\/object>$/mi; //placeholder
        var rEmbed = /<embed>.*?<\/embed>/i //placeholder
        var rFlv = /https?\/\/:\S+\.flv/i;
        //
...
<body>
    ...
    <asp:Panel ID="pnlMain" runat="server" Style="height: 650px;" class="panelDiv">
        ...
        <cc3:Flyout ID="Flyout1" runat="server" AttachTo="helpButton" OpenTime="200" PageOpacity="75"
            ...
            DelayTime="600">
            <div style="width: 480px; height:560px; background-color: #ffffff; padding: 20px 10px 10px 10px; border: solid 1px brown;">
                ...
                <tr>
                    ...
                    <td>
                        <cc2:ComboBox ID="cboOwner" runat="server" FolderStyle="./css/oboutSuite/ComboBox/styles/plain"
                            Width="200px" MenuWidth="200px" TabIndex="4" DataSourceID="ODSConciergeMaster"
