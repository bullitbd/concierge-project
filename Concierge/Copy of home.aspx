<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Copy of home.aspx.vb" Inherits="home"
...
<body>
    ...
    <div style="border: solid 1px green; width: 1000px; height: 775px; background-color: #FFFBD6;
        margin: 0 auto;">
        <div>
                                ...
                                <tr valign="top">
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtMedia" runat="server" BorderWidth="1" Width="375px" TextMode="MultiLine"
                                                        Rows="4"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <span style="font-weight: bold;">Draft Title:</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtDraftTitle" runat="server" BorderWidth="1" Width="375px" TextMode="singleline"
                                                        ></asp:TextBox>
                                                </td>
                                            </tr>
                                            </asp:Panel>
